...
export function NavigationMenuTop({ data }: { data: HeaderData }) {
  ...
  return (
    <NavigationMenu
      ...
      className="z-50 mr-0 flex  max-w-fit rounded-lg bg-white/80 dark:bg-background/40 px-0 shadow-sm max-[480px]:h-12 max-[480px]:max-w-full max-[480px]:rounded-none sm:px-6 min-[900px]:bg-transparent dark:min-[900px]:bg-transparent min-[900px]:px-2 min-[900px]:shadow-none lg:mr-4"
    >
      <NavigationMenuList>
        <MyItem
