...
export function BlogFeaturedPost({ post }: { post?: BlogPost }) {
  ...
  if (post) {
    return (
      <div className="mb-16 mt-10 grid gap-8 rounded-xl border  bg-white p-4 dark:border-teal-500/30 dark:bg-teal-950 sm:grid-cols-2 sm:items-start sm:p-8 lg:mb-24">
        ...
        <div className="px-4 sm:order-1 sm:col-span-1 sm:px-0">
          <p className="mb-5 inline-flex items-center gap-1.5 rounded-md bg-amber-400 px-3 py-1.5 text-xs font-medium text-gray-800 dark:bg-amber-700 dark:text-gray-200">
            Kiemelt cikk
          </p>
          ...
          <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200 md:text-3xl lg:text-4xl lg:leading-tight xl:text-5xl xl:leading-tight">
            <Link
              className="hover:text-amber-600 dark:text-gray-300 dark:hover:text-amber-500"
              href={"/blog/" + post.slug}
            >
              {post.title}
            </Link>
          ...
          <Link className="group" href={"/ingatlan-ugyved/" + author?.slug}>
            <div className="mt-6 flex items-center sm:mt-10">
              ...
              <div className="ml-3 sm:ml-4">
                <p className="font-semibold text-gray-800 transition-colors group-hover:text-amber-500 dark:text-gray-200 sm:mb-1">
          ...
          <div
            className="prose prose-lg mt-3 line-clamp-4 text-gray-600 dark:prose-invert dark:text-gray-400 sm:hidden md:visible md:line-clamp-2 lg:line-clamp-5"
          ...
          <div className="mt-5">
            <Link
              ...
              href={"/blog/" + post.slug}
            >
              <p className="text-md mt-4 inline-flex items-center gap-x-1 font-medium text-teal-600 group-hover:text-amber-600 dark:text-teal-500 ">
                Tovább
                <svg
