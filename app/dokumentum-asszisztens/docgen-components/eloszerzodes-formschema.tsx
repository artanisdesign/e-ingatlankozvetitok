...
export const formSchema = z
  .object({
    ...
    SellerBirthName: z
      .string({
        required_error: "Az eladó születési nevének megadása kötelező.",
      })
      .min(2, {
        message:
          "Az eladó születési neve legalább 2 karakter hosszú kell legyen.",
      }),
    SellerBirthPlaceAndDate: z
      .string({
        required_error: "Az eladó születési helye és ideje megadása kötelező.",
      })
      .min(6, {
        message:
          "Az eladó születési helye legalább 6 karakter hosszú kell legyen.",
      }),
    SellerMothersName: z
      .string({
        required_error: "Az eladó anyja nevének megadása kötelező.",
      })
      .min(2, {
        message: "Az eladó anyja neve legalább 2 karakter hosszú kell legyen.",
      }),
    SellerAddress: z
      .string({
        required_error: "Az eladó lakcímének megadása kötelező.",
      })
      .min(10, {
        message: "Az eladó lakcíme legalább 10 karakter hosszú kell legyen.",
      }),
    SellerPhone: z
      .string({
        required_error: "Az eladó telefonszámának megadása kötelező.",
      })
      .min(9, {
        message:
          "Az eladó telefonszáma legalább 9 karakter hosszú kell legyen.",
      }),
    SellerEmail: z
      .string({
        required_error: "Az eladó email címének megadása kötelező.",
      })
      .email({
        message: "Az eladó email címe nem megfelelő.",
      }),
    REAddress: z
      .string({
    ...
    WouldGiveBidSecAmount: z.boolean(),
    BidSecAmount: z.coerce
      .number({
        required_error: "_A foglaló megadása kötelező.",
        invalid_type_error: "A foglaló csak szám lehet.",
      })
  ...
  .refine(
    (data) =>
      data.WouldGiveBidSecAmount === false ||
      (data.WouldGiveBidSecAmount === true &&
        data.BidSecAmount &&
        data.BidSecAmount >= 500000),
    {
      message: "A foglaló megadása kötelező és legalább 500000 forint legyen.",
      path: ["BidSecAmount"],
    }
  )
